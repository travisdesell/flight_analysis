...
//            (*file) << " " << atof(flight_row->at(j).c_str());
            ...
            if (j < 4) {
                ...
                double blur = ((max[j] - min[j]) * 0.04) * drand48() - 0.02;
                (*file) << " " << atof(flight_row->at(j).c_str()) + blur;
            }
        }
        (*file) << endl;
    }
...
//                    continue;
        ...
        */
        write_flight_data(output_directory + to_string(flight_id), flight_data, column_names);
